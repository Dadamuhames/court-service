...
public enum ErrorCode {
    ...
    EXTERNAL_SERVICE_AUTH_INVALID_CODE(10420, "User authentication invalid"),
    ...
    OTP_EXPIRED_CODE(10470, "OTP expired or invalid"),
    OTP_REQUEST_LOCKED_CODE(10480, "OTP request locked. Wait and try again"),
    OTP_CHECK_LOCKED_CODE(10490, "Too many incorrect attempts. Wait and try again"),
    ...
    DECISION_AI_REQUEST_INVALID(10600, "Decision AI request invalid"),
